...
// Email Contacts Database (for email autocomplete and address book)
...
export const importShipments = pgTable("import_shipments", {
  ...
  lclContainer: boolean("lcl_container").default(false),
...
export const insertCustomClearanceSchema = createInsertSchema(customClearances).omit({
  ...
  jobType: z.enum(["import", "export"], { required_error: "Job Type is required" }),
