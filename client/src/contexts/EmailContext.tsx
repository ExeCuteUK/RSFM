...
interface EmailComposerData {
  ...
  isMinimized: boolean
  metadata?: {
    source?: 'book-delivery-customer' | 'advise-clearance-agent-import' | 'advise-clearance-agent' | 'advise-clearance-agent-export' | 'send-pod-customer' | 'send-pod-customer-export' | 'send-haulier-ead'
    shipmentId?: string
  }
}
