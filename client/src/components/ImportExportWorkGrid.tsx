          ...
          <table ref={tableRef} className={`w-full border-collapse text-xs ${editingCell ? 'table-fixed' : ''}`}>
            <thead className="sticky top-0 bg-muted z-10">
              <tr className="border-b-2">
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[0] ? { width: `${columnWidths[0]}px` } : undefined}>Job Ref</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[1] ? { width: `${columnWidths[1]}px` } : undefined}>Job Date</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[2] ? { width: `${columnWidths[2]}px` } : undefined}>Shipper Ref</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[3] ? { width: `${columnWidths[3]}px` } : undefined}>Customer Name</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[4] ? { width: `${columnWidths[4]}px` } : undefined}>Departure Date</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[5] ? { width: `${columnWidths[5]}px` } : undefined}>Destination / Port of Arrival</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[6] ? { width: `${columnWidths[6]}px` } : undefined}>Identifier</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[7] ? { width: `${columnWidths[7]}px` } : undefined}>Qty</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[8] ? { width: `${columnWidths[8]}px` } : undefined}>Weight</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[9] ? { width: `${columnWidths[9]}px` } : undefined}>CBM</th>
                ...
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[11] ? { width: `${columnWidths[11]}px` } : undefined}>Delivery Date</th>
                ...
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[13] ? { width: `${columnWidths[13]}px` } : undefined}>Quote Out / Net In</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[14] ? { width: `${columnWidths[14]}px` } : undefined}>Haulier</th>
                <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[15] ? { width: `${columnWidths[15]}px` } : undefined}>POD Sent</th>
                <th className="p-1 text-center font-semibold bg-muted" style={editingCell && columnWidths[16] ? { width: `${columnWidths[16]}px` } : undefined}>Booker</th>
              </tr>
            </thead>
            <tbody>
