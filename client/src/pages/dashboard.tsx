                ...
                <table className="w-full border-collapse text-xs table-fixed">
                  <thead className="sticky top-0 bg-background z-10">
                    <tr className="border-b-2">
                      ...
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Ligentia Ref</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-28">Haulier</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-28">Supplier</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-20">Country</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Destination</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Date of Collection</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Departure Date</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Truck Number</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-20">Port</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Eta Uk Port</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-20">Total Package</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-20">Weight</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Details Sent to Ligentia</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-24">Entry to Haulier</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-28">Delivery Booked Date</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-32">Price Out</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-background w-20">Pod Sent</th>
