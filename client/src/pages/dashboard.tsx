                ...
                <table ref={tableRef} className={`w-full border-collapse text-xs ${editingCell ? 'table-fixed' : ''}`}>
                  <thead className="sticky top-0 bg-muted z-10">
                    <tr className="border-b-2">
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted w-12" style={editingCell && columnWidths[0] ? { width: `${columnWidths[0]}px` } : undefined}>Hold</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[1] ? { width: `${columnWidths[1]}px` } : undefined}>Ref</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[2] ? { width: `${columnWidths[2]}px` } : undefined}>Job Date</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[3] ? { width: `${columnWidths[3]}px` } : undefined}>Consignee</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[4] ? { width: `${columnWidths[4]}px` } : undefined}>Container no.</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted w-20" style={editingCell && columnWidths[5] ? { width: `${columnWidths[5]}px` } : undefined}>Ship Line</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[6] ? { width: `${columnWidths[6]}px` } : undefined}>POA</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[7] ? { width: `${columnWidths[7]}px` } : undefined}>Vessel</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[8] ? { width: `${columnWidths[8]}px` } : undefined}>ETA Port</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[9] ? { width: `${columnWidths[9]}px` } : undefined}>References</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[10] ? { width: `${columnWidths[10]}px` } : undefined}>Delivery Date</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[11] ? { width: `${columnWidths[11]}px` } : undefined}>RLS</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[12] ? { width: `${columnWidths[12]}px` } : undefined}>Delivery Address</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[13] ? { width: `${columnWidths[13]}px` } : undefined}>Rate In</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[14] ? { width: `${columnWidths[14]}px` } : undefined}>Rate Out</th>
                      <th className="p-1 text-center font-semibold bg-muted w-48" style={editingCell && columnWidths[15] ? { width: `${columnWidths[15]}px` } : undefined}>Notes</th>
                    </tr>
                  </thead>
                        ...
                        return (
                          <tr key={shipment.id} className="border-b-2 hover-elevate h-24" data-testid={`row-container-${shipment.jobRef}`}>
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "deliveryRelease" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${releaseColor}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                            ...
                            {shipment.handoverContainerAtPort ? (
                              ...
                              <td className={`px-1 text-center border-r border-border align-middle ${addressColor}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="overflow-auto">
                <table ref={tableRef} className={`w-full border-collapse text-xs ${editingCell ? 'table-fixed' : ''}`}>
                  <thead className="sticky top-0 bg-muted z-10">
                    <tr className="border-b-2">
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[0] ? { width: `${columnWidths[0]}px` } : undefined}>Ref</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[1] ? { width: `${columnWidths[1]}px` } : undefined}>Ligentia Ref</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[2] ? { width: `${columnWidths[2]}px` } : undefined}>Job Date</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[3] ? { width: `${columnWidths[3]}px` } : undefined}>Haulier</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[4] ? { width: `${columnWidths[4]}px` } : undefined}>Supplier</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[5] ? { width: `${columnWidths[5]}px` } : undefined}>Country</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[6] ? { width: `${columnWidths[6]}px` } : undefined}>Destination</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[7] ? { width: `${columnWidths[7]}px` } : undefined}>Departure Date</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[8] ? { width: `${columnWidths[8]}px` } : undefined}>Identifier</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[9] ? { width: `${columnWidths[9]}px` } : undefined}>Port</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[10] ? { width: `${columnWidths[10]}px` } : undefined}>ETA Port</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[11] ? { width: `${columnWidths[11]}px` } : undefined}>QTY</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[12] ? { width: `${columnWidths[12]}px` } : undefined}>Weight</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[13] ? { width: `${columnWidths[13]}px` } : undefined}>Details Sent to Ligentia</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[14] ? { width: `${columnWidths[14]}px` } : undefined}>Entry to Haulier</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[15] ? { width: `${columnWidths[15]}px` } : undefined}>Delivery Booked Date</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[16] ? { width: `${columnWidths[16]}px` } : undefined}>Net Cost</th>
                      <th className="p-1 text-center font-semibold border-r border-border bg-muted" style={editingCell && columnWidths[17] ? { width: `${columnWidths[17]}px` } : undefined}>Price Out</th>
                      <th className="p-1 text-center font-semibold bg-muted" style={editingCell && columnWidths[18] ? { width: `${columnWidths[18]}px` } : undefined}>POD Sent</th>
                    </tr>
                  </thead>
                  <tbody className="text-xs">
                    {(() => {
                      ...
                      return paginatedNisbetsShipments.map((shipment) => {
                        ...
                        return (
                          <tr key={shipment.id} className="border-b-2 hover-elevate h-auto" data-testid={`row-nisbets-${shipment.jobRef}`}>
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "customerReferenceNumber" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.customerReferenceNumber)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.customerReferenceNumber)}`}
                            ...
                            {/* Job Date - EDITABLE DATE (Booking Date) */}
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "bookingDate" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.bookingDate)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.bookingDate)}`}
                                onClick={() => handleCellClick(shipment.id, "bookingDate", formatDate(shipment.bookingDate))}
                              >
                                <span className="block text-xs">{formatDate(shipment.bookingDate)}</span>
                              </td>
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "haulierName" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.haulierName)}`}>
                                <Select
                                  value={tempValue}
                                  onValueChange={(value) => {
                                    setTempValue(value)
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.haulierName)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "supplierName" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.supplierName)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.supplierName)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "departureCountry" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.departureCountry)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.departureCountry)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "deliveryAddress" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.deliveryAddress)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.deliveryAddress)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "dispatchDate" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.dispatchDate)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.dispatchDate)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "trailerOrContainerNumber" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.trailerOrContainerNumber)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.trailerOrContainerNumber)}`}
                                onClick={() => handleCellClick(shipment.id, "trailerOrContainerNumber", shipment.trailerOrContainerNumber || "")}
                              >
                                <span className="block text-xs">{shipment.trailerOrContainerNumber || ""}</span>
                              </td>
                            ...
                            {/* Port - EDITABLE TEXT */}
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "portOfArrival" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.portOfArrival)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.portOfArrival)}`}
                                onClick={() => handleCellClick(shipment.id, "portOfArrival", shipment.portOfArrival || "")}
                              >
                                <span className="block text-xs">{shipment.portOfArrival || ""}</span>
                              </td>
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "importDateEtaPort" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.importDateEtaPort)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.importDateEtaPort)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "numberOfPieces" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.numberOfPieces)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.numberOfPieces)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "weight" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsCellColor(shipment.weight)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsCellColor(shipment.weight)}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "sendHaulierEadStatusIndicatorTimestamp" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${(shipment.sendHaulierEadStatusIndicator === 2 || !shipment.sendHaulierEadStatusIndicator) ? "bg-yellow-200 dark:bg-yellow-500 text-gray-900 dark:text-gray-900" : (shipment.sendHaulierEadStatusIndicator === 3 ? "bg-green-100 dark:bg-green-900" : "")}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${(shipment.sendHaulierEadStatusIndicator === 2 || !shipment.sendHaulierEadStatusIndicator) ? "bg-yellow-200 dark:bg-yellow-500 text-gray-900 dark:text-gray-900" : (shipment.sendHaulierEadStatusIndicator === 3 ? "bg-green-100 dark:bg-green-900" : "")}`}
                            ...
                            {editingCell?.shipmentId === shipment.id && editingCell?.fieldName === "deliveryDate" ? (
                              <td className={`px-1 text-center border-r border-border align-middle ${getNisbetsDeliveryBookedDateColor(shipment)}`}>
                                <input
                                  ref={inputRef}
                                  type="text"
                                  value={tempValue}
                              ...
                              <td
                                className={`px-1 text-center border-r border-border align-middle cursor-pointer hover:ring-1 hover:ring-primary ${getNisbetsDeliveryBookedDateColor(shipment)}`}
