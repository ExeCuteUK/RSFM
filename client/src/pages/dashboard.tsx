...
export default function Dashboard() {
  ...
  const getClearanceStatusColor = (shipment: ImportShipment): string => {
    ...
    const clearance = getLinkedClearance(shipment.jobRef)
    if (!clearance) return "bg-yellow-200 dark:bg-yellow-500"
  ...
  const EditableCell = ({
    ...
    const cellColor = customCellColor || (value ? "bg-green-100 dark:bg-green-900" : "bg-yellow-200 dark:bg-yellow-500")
  ...
  const EditableStatusTimestampCell = ({
    ...
    const cellColor = statusIndicator === 3 ? "bg-green-100 dark:bg-green-900" : "bg-yellow-200 dark:bg-yellow-500"
                  ...
                  <tbody className="text-xs">
                    {(() => {
                      ...
                      const getCellColor = (value: string | null | undefined): string => {
                        return value ? "bg-green-100 dark:bg-green-900" : "bg-yellow-200 dark:bg-yellow-500"
                      }
