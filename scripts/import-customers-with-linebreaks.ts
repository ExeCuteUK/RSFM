...
async function importCustomersFromFile() {
  const fileContent = readFileSync('attached_assets/contacttest_1759498696764.txt', 'utf-8');
  ...
  for (const line of lines) {
    ...
    // Combine address fields 6-11 into a single address with line breaks
    ...
    // Combine agent address fields 17-22 into a single address with line breaks
