...
export class MemStorage implements IStorage {
  ...
  async createExportShipment(insertShipment: InsertExportShipment): Promise<ExportShipment> {
    ...
    const shipment: ExportShipment = {
      ...
      jobReference: insertShipment.jobReference ?? null,
      destination: insertShipment.destination ?? null,
      ...
      numPackages: insertShipment.numPackages ?? null,
      ...
      cargoWeight: insertShipment.cargoWeight ?? null,
      freightRateOut: insertShipment.freightRateOut ?? null,
      exportClearanceCost: insertShipment.exportClearanceCost ?? null,
  ...
  async updateExportShipment(id: string, updates: Partial<InsertExportShipment>): Promise<ExportShipment | undefined> {
    ...
    const updated: ExportShipment = { 
      ...
      jobReference: updates.jobReference !== undefined ? updates.jobReference ?? null : existing.jobReference,
      destination: updates.destination !== undefined ? updates.destination ?? null : existing.destination,
      ...
      numPackages: updates.numPackages !== undefined ? updates.numPackages ?? null : existing.numPackages,
      ...
      cargoWeight: updates.cargoWeight !== undefined ? updates.cargoWeight ?? null : existing.cargoWeight,
      freightRateOut: updates.freightRateOut !== undefined ? updates.freightRateOut ?? null : existing.freightRateOut,
      exportClearanceCost: updates.exportClearanceCost !== undefined ? updates.exportClearanceCost ?? null : existing.exportClearanceCost,
  ...
  async createCustomClearance(insertClearance: InsertCustomClearance): Promise<CustomClearance> {
    ...
    const clearance: CustomClearance = {
      ...
      departureCountry: insertClearance.departureCountry ?? null,
